...
<head>
    ...
    <style>
        ...
        * {
        ...
        .formularioproductos input:focus {
            outline: none;
            border-color: #667eea;
        ...
        .formularioproductos button:hover {
            transform: translateY(-2px);
        ...
        button[name="eliminarcliente"],
        button[name="eliminarproducto"] {
            background: linear-gradient(135deg, #f56565, #e53e3e);
            box-shadow: 0 4px 15px rgba(245, 101, 101, 0.3);
        }

        button[name="eliminar"]:hover,
        button[name="eliminarcliente"]:hover,
        button[name="eliminarproducto"]:hover {
        ...
        #modal-cerrar:hover,
        #modal-cerrarcliente:hover,
        #modal-cerrarproductos:hover,
        #modal-cerraradmin:hover {
            color: #e53e3e;
            background: #fed7d7;
        }
